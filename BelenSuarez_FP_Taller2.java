...
public class BelenSuarez_FP_Taller2 {
    ...
    public static void main(String[] args) {
        ...
        // Variables iniciales basadas estrictamente en tu Taller 1
        ...
        // Bucle básico de repetición exigido por la guía del Taller 2
        while (continuar && asientosDisponibles > 0) {
            
            // 1. Solicitar P, TB y HF (Tal como tu pseudocódigo)
            ...
            // Control básico del bucle interactivo
